...
![Jetson Nano](../Anomaly-Detection-on-Jetson-Nano-with-Chatbot/Jetson%20Nano/jetson.jpg)
...
```bash
git clone https://github.com/Joseph-Essa/Anomaly-Detection-on-Jetson-Nano-with-Chatbot.git
